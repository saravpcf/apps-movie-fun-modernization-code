...
import org.superbiz.moviefun.HomeController;
...
public class AlbumsClient {
    ...
    private Logger logger = LoggerFactory.getLogger(AlbumsClient.class);
    ...
    public void addAlbum(AlbumInfo album) {
        logger.info("POSTING ALBUM >>>>> " + album.getArtist() + albumsUrl);
